...
public class PuntApplicatie {
	...
	public static void main(String[] args) {
		...
		String vraag1 = "Geef eerste coördinaat in : ",
				vraag2 = "Geef tweede coördinaat in : ",
		...
		vraag1 = String.format("Geef eerste coördinaat in (%d om te stoppen):", eerste.getX());
		vraag2 = String.format("Geef tweede coördinaat in (%d om te stoppen):", eerste.getY());
